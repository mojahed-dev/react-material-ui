...
const MuiAccordion = () => {
  ...
  return (
    ...
    <Accordion expanded={ expanded === 'panel1' } onChange={ (event, isExpanded) => handleChange(isExpanded, 'panel1') }>
      ...
      <AccordionDetails><Typography>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe vero sed non natus. Soluta enim voluptatem nulla. Doloribus, veniam at!</Typography></AccordionDetails>
    </Accordion>
